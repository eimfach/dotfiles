...
alias gcmma='git commit --amend -m'
alias ga='git add'
...
alias gm='git merge'
alias gd='git diff'
alias usetheforceluke='echo "You are not my father, Ben"; git checkout --force'
alias ssh-add='ssh-add -K'

figlet have fun | lolcat

fortune -s wisdom science sports computers education cookie love riddles | cowsay | lolcat

printf "\n\n\n Remember: Stay creative, but don't forget to get shit done !"

alias starwars='telnet towel.blinkenlights.nl'

alias encrypt='openssl enc -aes-256-cbc -e -in {path-in} -out {path-out}'
alias decrypt='openssl enc -aes-256-cbc -d -in {path-in} -out {path-out}'

alias ushedule='defaults write com.apple.SoftwareUpdate ScheduleFrequency -int 1'
...
#   Change Prompt
#   ------------------------------------------------------------
    export PS1="\n\n| \w @ \h (\u) \n| \$(parse_git_branch)\$(parse_git_hash | lolcat -f) \n| => "
...
maxCompress() { tar c "$1" | gz99 "$2".gz; }
# https://raw.githubusercontent.com/eimfach/joshell/master/scripts/gz99
...
export XRAY_SRC_PATH="/Users/robingruenke/Documents/workspaces/xray"
